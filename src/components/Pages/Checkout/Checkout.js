      ...
      {props.isOrderLoading ? (
        ...
        <>
          {props.orderPlaced ? (
            ...
            <>
              {props.cart.length === 0 ? <Redirect to="./menu" /> : null}
                ...
                {props.isAddressLoading ? (
                  ...
                  <>
                    ...
                    {addressFormShown ? (
                      <AddressForm
                        {...props.address}
                        hideAddressForm={() => setAddressFormShown(false)}
                      />
                    ) : props.addressError === 'No Address Found' ? (
                      <>
                        <ErrorDisplay>{props.addressError}</ErrorDisplay>
                ...
                <form>
                  <div className="col-12 mt-4">
                    <RadioButton
                      ...
                      code="CashOnDelivery"
                      isRequired
                      clickFunc={() => setModeSelected(true)}
                    >
                      Cash on Delivery
                    </RadioButton>
                    <RadioButton
                  ...
                  <div className="col-12">
                    {props.orderError ? (
                      <ErrorDisplay>{props.orderError}</ErrorDisplay>
                    ) : null}
                  </div>
